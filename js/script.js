...
//Recuperation du type de generateur choisi

//generation de la phrase au clic sur le bouton
btnElt.addEventListener("click", function(){// ajout d'un ecouteur d'evenement sur le bouton Générer
    ...
    typeGen = document.getElementById("typeGen").value;// selection du type de genrateur
    reponseDiv.innerHTML = ""; // on efface le contenu de la div
    if (typeGen == "horoscope"){
        ...
        var child = document.createElement("p"); // creation d'un nouveau paragraphe
            child.textContent = "En construction: Cette fonctionnalité sera disponible prochainement"; // definition du contenu du paragraphe
            reponseDiv.appendChild(child); // ajout du paragraphe dans la div     
    }
